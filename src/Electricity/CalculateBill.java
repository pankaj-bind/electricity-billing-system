...
public class CalculateBill extends JFrame implements ActionListener {
    ...
    CalculateBill() {
        ...
        p = new JPanel();
        p.setLayout(null);
        p.setBackground(new Color(173, 316, 230));
        ...
        JLabel l16 = new JLabel("Name");
        l16.setBounds(60, 120, 100, 30);

        JLabel l17 = new JLabel("Address");
        l17.setBounds(60, 170, 100, 30);
        ...
        c1.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent ae) {
                try {
                    Conn c = new Conn();
                    ResultSet rs = c.s
                            .executeQuery("select * from customer where meter = '" + c1.getSelectedItem() + "'");
                    while (rs.next()) {
                        l11.setText(rs.getString("name"));
                        l12.setText(rs.getString("address"));
                    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String q = "insert into bill values('" + meter + "','" + month + "','" + units + "','" + totalBill + "')";
            try {
                Conn c1 = new Conn();
